...
export default class Popular extends React.Component{
    ...
    async componentDidMount(){
        fetch('https://api.themoviedb.org/3/movie/upcoming?api_key=YOUR_API_KEY&language=en-US&page=2')
        .then((res)=>res.json())
        .then((response)=>this.setState({
            pagetwo : response.results,
        }))
        fetch('https://api.themoviedb.org/3/movie/upcoming?api_key=YOUR_API_KEY&language=en-US&page=3')
        .then((res)=>res.json())
        .then((response)=>this.setState({
            pagethree : response.results,
        }))
        fetch('https://api.themoviedb.org/3/movie/upcoming?api_key=YOUR_API_KEY&language=en-US&page=4')
        .then((res)=>res.json())
        .then((response)=>this.setState({
            pagefour : response.results,
        }))
        fetch('https://api.themoviedb.org/3/movie/upcoming?api_key=YOUR_API_KEY&language=en-US&page=5')
        .then((res)=>res.json())
        .then((response)=>this.setState({
